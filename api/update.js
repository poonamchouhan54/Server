...
async function handler(req, res) {
    try {
        ...
        await db.ref("m3u/playlist").set(playlist);
        await db.ref("m3u/lastUpdate").set(Date.now());
        ...
        return res.status(200).send(`
            ...
            <head>
                ...
                <style>
                    ...
                    .box { background: #1e1e1e; padding: 25px; border-radius: 12px; display: inline-block; border: 2px solid #00ff00; box-shadow: 0 4px 15px rgba(0,255,0,0.3); }
                    h2 { color: #00ff00; margin-bottom: 10px; }
                    .code { font-size: 18px; font-weight: bold; color: #fff; margin: 20px 0; letter-spacing: 1px; background: #000; padding: 10px; border-radius: 8px; }
            ...
            <body>
                <div class="box">
                    ...
                    <p>Playlist Firebase Realtime Database me successfully save ho chuki hai!</p>
                    <div class="code">m3u/playlist & m3u/lastUpdate</div>
                    <p>✅ Sabhi data update ho gaya hai.</p>
                </div>
            </body>
            </html>
        `);
        ...
        return res.status(500).send(`
            ...
            <head>
                ...
                <style>
                    ...
                    .code { font-size: 14px; font-weight: bold; color: #ff5555; margin: 20px 0; background: #000; padding: 10px; border-radius: 8px; word-break: break-all; }
                </style>
            </head>
            <body>
                <div class="box">
